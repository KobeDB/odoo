...
class SaleOrderLineLoyalty(models.Model):
    ...
    def _compute_name(self):
        ...
        super(SaleOrderLineLoyalty, self - reward)._compute_name()
    ...
    def _compute_tax_id(self):
        ...
        super(SaleOrderLineLoyalty, self - reward_lines)._compute_tax_id()
    ...
    def unlink(self):
        ...
        for line in related_lines:
            if line.state == 'sale':
                line.coupon_id.points += line.points_cost
        res = super(SaleOrderLineLoyalty, self | related_lines).unlink()
